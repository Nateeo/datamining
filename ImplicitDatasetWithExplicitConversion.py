...
class ImplicitDatasetWithExplicitConversion(Dataset):
    ...
    * :code:`item_id`: the item involved in the interaction.
    ...
    def __init__(self, raw_data, max_user, max_item, name='dataset'):
        super(ImplicitDatasetWithExplicitConversion, self).__init__(raw_data=raw_data, max_user=max_user, max_item=max_item, name=name)
